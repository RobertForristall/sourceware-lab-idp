...
public class IdpKeyStoreAccessorTests {
	...
	private final IdpKeyStoreData rsaIdpKeyStoreData = new IdpKeyStoreData(storeDir, storeName, storePass, rsaKeyAlias, rsaKeyPass, rsaKeyId);
	...
	public void setupKeystores() {
		...
		Assertions.assertTrue(IdpKeyStoreAccessor.prepareKeyStoreAndSet(JWSAlgorithm.RS384, rsaIdpKeyStoreData));
	}
	...
	public void testEcKey() throws KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, OperatorCreationException, IOException, JOSEException {
		Assertions.assertInstanceOf(ECKey.class, IdpKeyStoreAccessor.accessKeyStore(JWSAlgorithm.ES256, ecIdpKeyStoreData));
	}
	...
	public void testRsaKey() throws KeyStoreException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, OperatorCreationException, IOException, JOSEException {
		Assertions.assertInstanceOf(RSAKey.class, IdpKeyStoreAccessor.accessKeyStore(JWSAlgorithm.RS384, rsaIdpKeyStoreData));
	}
}
